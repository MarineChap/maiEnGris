...
export default function StatsHeader({ currentKm, finalPeakKm, nextRace, onDonate, onAddKm }) {
    ...
    <>
      <div className="stats-header-wave" aria-hidden="true">
        <svg viewBox="0 0 1440 72" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,0 C300,55 480,5 720,32 C960,58 1140,4 1440,0 L1440,72 L0,72 Z" fill="#1D2B52" />
          <path d="M0,0 C300,55 480,5 720,32 C960,58 1140,4 1440,0" fill="none" stroke="white" strokeWidth="1.2" opacity="0.4" />
        </svg>
      </div>
